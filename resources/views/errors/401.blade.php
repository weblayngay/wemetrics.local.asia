...
<div class="row" style="position: absolute; top: 5%; left: 30%">
    <div class="col-md-12">
        <img src="{{ ADMIN_DIST_ICON_URL. DS. 'errors'. DS. '401.gif' }}" alt="{{__($companyName)}}">
    </div>
</div>
<div class="row" style="margin: 30% 20% 0% 25%;">
    <div class="col-md-12">
        <h2 class="font-weight-bolder danger"><i class="fa-duotone fa-face-holding-back-tears"></i> 401 Unauthorized</h2>
        <p><span><strong>The HyperText Transfer Protocol (HTTP) 401 Unauthorized response status code indicates that the client request has not been completed because it lacks valid authentication credentials for the requested resource.</strong></span></p>
    </div>
</div>
