...
<div class="row" style="position: absolute; top: 5%; left: 30%">
    <div class="col-md-12">
        <img src="{{ ADMIN_DIST_ICON_URL. DS. 'errors'. DS. '500.gif' }}" alt="{{__($companyName)}}">
    </div>
</div>
<div class="row" style="margin: 30% 20% 0% 25%;">
    <div class="col-md-12">
        <h2 class="font-weight-bolder danger"><i class="fa-duotone fa-face-holding-back-tears"></i> 500 Internal Server Error</h2>
        <p><span><strong>The HyperText Transfer Protocol (HTTP) 500 Internal Server Error server error response code indicates that the server encountered an unexpected condition that prevented it from fulfilling the request.</strong></span></p>
        <p><span><strong>This error response is a generic "catch-all" response. Usually, this indicates the server cannot find a better 5xx error code to response. Sometimes, server administrators log error responses like the 500 status code with more details about the request to prevent the error from happening again in the future.</strong></span></p>
    </div>
</div>
