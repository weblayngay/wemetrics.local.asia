...
<div class="row" style="position: absolute; top: 5%; left: 30%">
    <div class="col-md-12">
        <img src="{{ ADMIN_DIST_ICON_URL. DS. 'errors'. DS. '404.gif' }}" alt="{{__($companyName)}}">
    </div>
</div>
<div class="row" style="margin: 30% 20% 0% 25%;">
    <div class="col-md-12">
        <h2 class="font-weight-bolder danger"><i class="fa-duotone fa-face-holding-back-tears"></i> 404 - Page not found</h2>
        <p><span><strong>404 is a status code that tells a web user that a requested page is not available. 404 and other response status codes are part of the web's Hypertext Transfer Protocol response codes. The 404 code means that a server could not find a client-requested webpage.</strong></span></p>
    </div>
</div>
