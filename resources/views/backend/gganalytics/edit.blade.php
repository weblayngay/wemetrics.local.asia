...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.gganalytics.gganalytics_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('gganalytics', 'update')}}" enctype="multipart/form-data">
