...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.menugroup.menugroup_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('menugroup', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <fieldset class="form-group">
                                                            <label for="name">{{__('Tên nhóm menu')}} <span class="red">*</span></label>
                                                        </fieldset>
                                                        <hr>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Tên nhóm menu">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row" style="display: none;">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="code" class="form-control slug" placeholder="Mã">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
