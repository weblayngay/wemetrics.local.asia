...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.product.product_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('product', 'update')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table mb-0">
                                                                    ...
                                                                    <select name="pcatId" class="form-control custom-select form-control custom-select-sm mt-15">
                                                                        ...
                                                                        @foreach($productCategories as $item)
                                                                            @php
                                                                                $level = $item->level - 2;
                                                                            @endphp
                                                                            @if(@$product->pcat_id == $item->pcat_id)
                                                            ...
                                                            {{--<tr>
                                                                ...
                                                                <td>
                                                                    <select name="group" class="form-control custom-select form-control custom-select-sm mt-15">
                                                                        <option value="">--- Chọn nhóm ---</option>
                                                                        <option value="new" @if($product->product_group == 'new')selected @endif>Mới</option>
                                                                        <option value="sell_a_lot" @if($product->product_group == 'sell_a_lot')selected @endif>Bán chạy</option>
                                                                        <option value="sale" @if($product->product_group == 'sale')selected @endif>Khuyến mãi</option>
                                                                    </select>
                                                                </td>
                                                            </tr>--}}
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="number" name="weight" class="form-control form-control-sm" value="{{ $product->product_weight }}" placeholder="Nhập trọng lượng (gram)"></td>
                                                            </tr>
                                                            <tr>
