...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.voucher.voucher_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('voucher', 'duplicate')}}" enctype="multipart/form-data">
...
@include('backend.elements.ajax.voucher.voucher_copy')
