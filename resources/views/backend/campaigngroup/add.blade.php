...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.campaigngroup.campaigngroup_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('campaigngroup', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Tên nhóm chiến dịch">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                            ...
                            <div class="tab-pane fade" id="nav-upload" role="tabpanel" aria-labelledby="nav-upload-tab">
                                <div class="col-xl-12">
                                    <section class="hk-sec-wrapper">
                                        ...
                                        <input type="file" name="imageAvatar" class="dropify" data-max-file-size="5M" data-allowed-file-extensions="pdf png psd webp jpg jpeg" />
                                    </section>
                                </div>
                            </div>
                        </div>
