...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingreplacereqrui.clienttrackingreplacereqrui_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingreplacereqrui', 'duplicate')}}" enctype="multipart/form-data">
