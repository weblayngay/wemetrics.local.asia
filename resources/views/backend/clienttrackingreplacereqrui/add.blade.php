...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingreplacereqrui.clienttrackingreplacereqrui_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingreplacereqrui', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="value" class="form-control" placeholder="Từ khóa" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="replaceStr" class="form-control" placeholder="Thay thế" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
