...
<html lang="en" data-textdirection="ltr" class="loaded">
    ...
    <body class="vertical-layout vertical-menu-modern 2-columns navbar-sticky footer-static menu-expanded" data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
        ...
        @include('backend.elements.children.preloaderlist.index')
            ...
            <div class="app-content content">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="content-body">
                        @include('backend.elements.content_search', ['search' => 'backend.elements.searchs.kiotvietcustomer.kiotvietcustomer_preload_search'])
                    </div>
                </div>
            </div>
            <!-- END: Content-->
        ...
        @include('backend.elements.ajax.kiotviet.preload.kiotvietcustomer_preload') 
    </body>
</html>