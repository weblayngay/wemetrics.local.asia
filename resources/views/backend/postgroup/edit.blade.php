...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.postgroup.postgroup_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('postgroup', 'update')}}" enctype="multipart/form-data">
        <input type="hidden" name="action_type">
        <input type="hidden" name="id" value="{{$group->postgroup_id}}">
        @csrf
        <div class="row">
            <div class="col-xl-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <fieldset class="form-group">
                                                            <label for="name">{{__('Tên Nhóm Bài viết')}} <span class="red">*</span></label>
                                                        </fieldset>
                                                        <hr>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Tên nhóm bài viết" value="{{ $group->postgroup_name }}">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="slug" class="form-control" placeholder="slug" value="{{ $group->postgroup_slug }}">
                                                        </fieldset>
                                                    </div>
                                                </div>                                                 
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            ...
                                                            <a href="{{ config('app.url').'/'.POSTGROUP_TAXONOMY.'/'.$group->postgroup_url }}" target="_blank" id="url" name="url">{{ $group->postgroup_url }}</a>
                                                        </fieldset>
                                                    </div>
                                                </div>                                                
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <select class="form-control select2" name="parent">
                                                                ...
                                                                @include(POST_GROUP_PARENT, ['parents' => $parents, 'parentId' => $parentId, 'sub' => POST_GROUP_SUB, 'node' => $node, 'separate' => SEPARATE, 'verticalBar' => VERTICAL_BAR])
                                                            </select>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="status" value="activated" @if($group->postgroup_status == 'activated') checked @endif>
                                                                <label class="form-check-label" >{{__('Có')}}</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="status" value="inactive" @if($group->postgroup_status == 'inactive') checked @endif>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <textarea id="editor_short" name="description" class="form-control" placeholder="Nhập mô tả">{!! $group->postgroup_description !!}</textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="metaTitle" class="form-control" placeholder="" value="{{ $group->postgroup_meta_title }}">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="metaKeywords" class="form-control" placeholder="" value="{{ $group->postgroup_meta_keywords }}">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="metaDescription" class="form-control" placeholder="" value="{{ $group->postgroup_meta_description }}">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                            </div>
