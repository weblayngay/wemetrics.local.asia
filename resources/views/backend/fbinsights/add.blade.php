...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.fbinsights.fbinsights_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('fbinsights', 'store')}}" enctype="multipart/form-data">
