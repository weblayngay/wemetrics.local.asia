...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.fbinsights.fbinsights_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('fbinsights', 'update')}}" enctype="multipart/form-data">
