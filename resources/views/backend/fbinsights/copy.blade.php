...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.fbinsights.fbinsights_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('fbinsights', 'duplicate')}}" enctype="multipart/form-data">
