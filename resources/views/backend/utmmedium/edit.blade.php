...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.utmmedium.utmmedium_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('utmmedium', 'update')}}" enctype="multipart/form-data">
