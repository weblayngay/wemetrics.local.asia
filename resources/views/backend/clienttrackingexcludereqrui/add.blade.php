...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingexcludereqrui.clienttrackingexcludereqrui_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingexcludereqrui', 'store')}}" enctype="multipart/form-data">
