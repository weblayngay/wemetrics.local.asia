...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ctokenin.ctokenin_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ctokenin', 'update')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-2">
                                                        <fieldset class="form-group">
                                                            <label for="name">{{__('Domain')}} <span class="red">*</span></label>
                                                        </fieldset>
                                                        <hr>
                                                    </div>
                                                    <div class="col-md-10">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="clientId" class="form-control" placeholder="Khóa Client Id" value="{{ $token->client_id }}" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="clientKey" class="form-control" placeholder="Khóa Client Key" value="{{ $token->client_key }}" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>                                                                                           
                                                <div class="row">
