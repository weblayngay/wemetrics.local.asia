...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ctokenvendor.vendor_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ctokenvendor', 'update')}}" enctype="multipart/form-data">
