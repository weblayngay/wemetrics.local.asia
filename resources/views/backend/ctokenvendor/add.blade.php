...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ctokenvendor.ctokenvendor_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ctokenvendor', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Tên nhà cung cấp kết nối">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
