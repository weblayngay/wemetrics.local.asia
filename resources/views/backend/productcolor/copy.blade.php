...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productcolor.productcolor_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productcolor', 'duplicate')}}" enctype="multipart/form-data">
