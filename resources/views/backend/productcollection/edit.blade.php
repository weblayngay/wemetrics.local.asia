...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productcollection.productcollection_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productcollection', 'update')}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table mb-0">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><input type="text" name="name" class="form-control form-control-sm" value="{{ $collection->pcollection_name }}" placeholder="Tên bộ sưu tập"></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Bật</th>
                                                                <td>
