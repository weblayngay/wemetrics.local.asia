...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productcollection.productcollection_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productcollection', 'store')}}" enctype="multipart/form-data">
                                                        ...
                                                        <table class="table mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="name" class="form-control form-control-sm" placeholder="Tên bộ sưu tập"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Bật</th>
                                                                    <td>
