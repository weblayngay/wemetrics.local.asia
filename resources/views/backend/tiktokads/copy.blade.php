...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.tiktokads.tiktokads_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('tiktokads', 'duplicate')}}" enctype="multipart/form-data">
