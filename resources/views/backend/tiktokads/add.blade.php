...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.tiktokads.tiktokads_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('tiktokads', 'store')}}" enctype="multipart/form-data">
