...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ggadwords.ggadwords_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ggadwords', 'update')}}" enctype="multipart/form-data">
