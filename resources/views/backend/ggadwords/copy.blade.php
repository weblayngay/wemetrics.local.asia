...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ggadwords.ggadwords_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ggadwords', 'duplicate')}}" enctype="multipart/form-data">
