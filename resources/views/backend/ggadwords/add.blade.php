...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.ggadwords.ggadwords_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('ggadwords', 'store')}}" enctype="multipart/form-data">
