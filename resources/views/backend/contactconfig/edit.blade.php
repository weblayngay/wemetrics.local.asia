...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.contactconfig.contactconfig_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('contactconfig', 'update')}}" enctype="multipart/form-data">
