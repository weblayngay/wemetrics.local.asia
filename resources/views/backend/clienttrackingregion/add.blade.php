...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingregion.clienttrackingregion_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingregion', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="code" class="form-control" placeholder="Mã địa điểm" required="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Tên địa điểm" required="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="nation" class="form-control" placeholder="Quốc gia" required="">
