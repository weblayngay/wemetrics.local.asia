...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productsize.productsize_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productsize', 'store')}}" enctype="multipart/form-data">
                                                        ...
                                                        <table class="table mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="value" class="form-control form-control-sm" placeholder=""></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Code<span class="red">*</span></th>
                                                                    <td><input type="text" name="code" class="form-control form-control-sm" placeholder="Tên kích thước"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Bật</th>
                                                                    <td>
