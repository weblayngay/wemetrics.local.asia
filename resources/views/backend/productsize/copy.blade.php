...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productsize.productsize_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productsize', 'duplicate')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="table-wrap">
                                                    <div class="table-responsive">
                                                        <table class="table mb-0">
                                                            <tbody>
                                                            <tr>
                                                                <th scope="row">Mo tả ngắn<span class="red">*</span></th>
