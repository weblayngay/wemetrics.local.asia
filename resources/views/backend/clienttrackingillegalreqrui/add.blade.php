...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingillegalreqrui.clienttrackingillegalreqrui_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingillegalreqrui', 'store')}}" enctype="multipart/form-data">
