...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingillegalreqrui.clienttrackingillegalreqrui_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingillegalreqrui', 'update')}}" enctype="multipart/form-data">
