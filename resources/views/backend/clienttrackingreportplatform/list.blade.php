...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingreportplatform.clienttrackingreportplatform_list'])
    @include('backend.elements.content_search', ['search' => 'backend.elements.searchs.clienttrackingreportplatform.clienttrackingreportplatform_search'])
    <div class="row">
        <div class="col-xl-12">
                    ...
                    <div class="col-sm">
                        <div class="table-wrap" style="overflow-x:auto;">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset class="form-group">
                                        <div id="chartTotalTrafficPlatformByDate" name="chartTotalTrafficPlatformByDate">
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
...
@parent
    @include('backend.elements.ajax.clienttracking.clienttrackingreportplatform_list')
    ...
    @include('backend.elements.ajax.clienttracking.items.chartTotalTrafficPlatformByDate')
@endsection