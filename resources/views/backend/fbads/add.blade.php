...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.fbads.fbads_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('fbads', 'store')}}" enctype="multipart/form-data">
