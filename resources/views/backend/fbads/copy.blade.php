...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.fbads.fbads_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('fbads', 'duplicate')}}" enctype="multipart/form-data">
