<form id="report-form" method="POST" action="{{app('UrlHelper')::admin('kiotvietproductreportoverview', 'preloadstats')}}" enctype="multipart/form-data" class="txt-al-l">
	@csrf
    <div class="row">
        ...
        <div class="col-md-1 pb-10 txt-al-r">
            <a data-url='{{app('UrlHelper')::admin('kiotvietproductreportoverview', 'preloadstats')}}' class='js-report'>
