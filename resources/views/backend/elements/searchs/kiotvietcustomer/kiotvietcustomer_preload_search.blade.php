<form id="search-form" method="POST" action="{{app('UrlHelper')::admin('kiotvietCustomer', 'search')}}" enctype="multipart/form-data" class="txt-al-l">
	@csrf
    <div class="row">
        ...
        <div class="col-md-1 pb-10 txt-al-r">
        	<a data-url='{{app('UrlHelper')::admin('kiotvietCustomer', 'search')}}' class='js-search button-search'>
