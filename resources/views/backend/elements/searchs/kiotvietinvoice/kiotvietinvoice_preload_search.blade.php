<form id="search-form" method="POST" action="{{app('UrlHelper')::admin('kiotvietInvoice', 'search')}}" enctype="multipart/form-data" class="txt-al-l">
	@csrf
    <div class="row">
        ...
        <div class="col-md-1 pb-10 txt-al-r">
            <a data-url='{{app('UrlHelper')::admin('kiotvietInvoice', 'search')}}' class='js-search button-search'>
