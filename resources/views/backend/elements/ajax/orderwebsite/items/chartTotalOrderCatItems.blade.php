<script type="text/javascript">
    function chartTotalOrderCatItems(data) {
        // Load Data
        var series = [];
        var labels = [];
        ...
        jQuery.each(data.orderCatItems, function( i, item ) {
          series.push(parseInt(data.orderCatItems[i].total_price));
          labels.push(data.orderCatItems[i].catname);
        });
        var options = {
        chart: {
          type: 'pie',
        ...
        var chart = new ApexCharts(document.querySelector("#chartTotalOrderCatItems"), options);
        chart.render();
    }
</script>