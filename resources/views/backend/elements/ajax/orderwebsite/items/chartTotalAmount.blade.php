<script type="text/javascript">
    function chartTotalAmount(data) {
        ...
        var title_text = 'Thống kê doanh số';
        var legend_fontSize = '14px';
        var legend_fontWeight = 'bolder';
        var palette = 'palette5';
        jQuery.each(data.totalAmount, function( i, item ) {
          series.push(parseInt(data.totalAmount[i].total));
          labels.push(data.totalAmount[i].label);
        });
        var options = {
        chart: {
          type: 'pie',
