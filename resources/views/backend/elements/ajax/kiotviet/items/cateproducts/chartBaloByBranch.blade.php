<script type="text/javascript">
    function chartBaloByBranch(data) {
        // Load Data
        var series = [];
        var labels = [];
        ...
        var title_text = 'Thống kê balo theo cửa hàng';
        ...
        jQuery.each(data.baloByBranch, function( i, item ) {
          if(i < 5)
          {
            series.push(parseInt(data.baloByBranch[i].quantity));
            labels.push(data.baloByBranch[i].branchName);
          }
        });
        ...
        var chart = new ApexCharts(document.querySelector("#chartBaloByBranch"), options);
        chart.render();
    }
</script>