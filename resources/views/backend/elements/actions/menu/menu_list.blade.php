<a href='{{app('UrlHelper')::admin('menu', 'index?group='.$group)}}' class='button-refresh'>
...
<a data-url='{{app('UrlHelper')::admin('menu', 'edit')}}' class="js-edit">
