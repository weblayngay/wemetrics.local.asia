<a data-url='{{app('UrlHelper')::admin('campaigngroup', 'store')}}' class='js-post-add' data-action-type="save">
    <button class='btn btn-outline-primary btn-action-120'><i class='glyphicon glyphicon-plus'></i>{{__(SAVE_BUTTON_LABEL)}}</button>
</a>
<a data-url='{{app('UrlHelper')::admin('campaigngroup', 'store')}}' class="js-post-add" data-action-type="save_add">
