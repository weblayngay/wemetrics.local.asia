<a data-url='{{app('UrlHelper')::admin('productsize', 'update')}}' class='js-post-edit' data-action-type="save">
    <button class='btn btn-outline-primary btn-action-120'><i class='glyphicon glyphicon-plus'></i> Lưu</button>
</a>
<a data-url='{{app('UrlHelper')::admin('productsize', 'update')}}' class="js-post-edit" data-action-type="save_edit">
