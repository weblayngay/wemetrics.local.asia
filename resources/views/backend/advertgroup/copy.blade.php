...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.advertgroup.advertgroup_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('advertgroup', 'duplicate')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="code" class="form-control" placeholder="Tên nhóm quảng cáo" value="{{ $adgroup->adgroup_code }}">
                                                            <span class="span-guide-text-green">{{__('Sử dụng định dạng slug (chữ thường và dấu - example-slug)')}}</span>
                                                        </fieldset>
                                                    </div>
                                                </div>                                                
                                                <div class="row">
