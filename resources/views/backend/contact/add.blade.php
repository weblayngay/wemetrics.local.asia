...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.contact.contact_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('contact', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="name" class="form-control" placeholder="Người liên hệ" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="tel" name="phoneNumber" class="form-control" placeholder="Điện thoại">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <textarea type="text" name="content" class="form-control" placeholder="Nhập nội dung"></textarea>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
