...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productnutritions.productnutritions_copy'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productnutritions', 'duplicate')}}" enctype="multipart/form-data">
