...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.productnutritions.productnutritions_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('productnutritions', 'store')}}" enctype="multipart/form-data">
                                                        ...
                                                        <table class="table mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="name" class="form-control form-control-sm" placeholder="Tên dưỡng chất"></td>
                                                                </tr>
                                                                <tr>
                                                                    <th scope="row">Bật</th>
                                                                    <td>
