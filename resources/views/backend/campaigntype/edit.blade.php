...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.campaigntype.campaigntype_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('campaigntype', 'update')}}" enctype="multipart/form-data">
