...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.post.post_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('post', 'store')}}" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isHot" value="yes" checked="">
                                                                <label class="form-check-label" >{{__('Có')}}</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isHot" value="no">
                                                                <label class="form-check-label">{{__('Không')}}</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isNew" value="yes" checked="">
                                                                <label class="form-check-label" >{{__('Có')}}</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isNew" value="no">
                                                                <label class="form-check-label">{{__('Không')}}</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isView" value="yes" checked="">
                                                                <label class="form-check-label" >{{__('Có')}}</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="isView" value="no">
                                                                <label class="form-check-label">{{__('Không')}}</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
...
{{--                                                                <td><input type="text" name="nameEn" class="form-control form-control-sm" placeholder="Tên Bài viết"></td>--}}
{{--                                                            </tr>--}}
{{--                                                            <tr>--}}
...
{{--                                                                <td><textarea id="editor_en" name="contentEn" class="form-control" placeholder="Nhập nội dung"></textarea></td>--}}
{{--                                                            </tr>--}}
{{--                                                            <tr>--}}
                                    ...
                                    <select class="select2 select2-multiple" name="related[]" multiple="multiple" data-placeholder="Choose">
                                        @if($posts->count() > 0)
                                            @foreach($posts as $key => $itemPost)
                                                <option value="{{ $itemPost->post_id }}">{{ $itemPost->post_name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
