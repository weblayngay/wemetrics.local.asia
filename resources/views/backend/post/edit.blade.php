                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="slug" class="form-control" placeholder="slug" value="{{ $post->post_slug }}">
                                                        </fieldset>
                                                    </div>
                                                </div>                                                
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            ...
                                                            <a href="{{ config('app.url').'/'.POST_TAXONOMY.'/'.$post->post_url }}" target="_blank" id="url" name="url">{{ $post->post_url }}</a>
                                                        </fieldset>
                                                    </div>
                                                </div>                                                
                                                <div class="row">
