...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.campaign.campaign_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('campaign', 'update')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="slug" class="form-control" placeholder="slug" value="{{ $campaign->campaign_slug }}">
                                                        </fieldset>
                                                    </div>
                                                </div>                                                 
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            ...
                                                            <a href="{{ config('app.url').'/'.CAMPAIGN_TAXONOMY.'/'.$campaign->campaign_url }}" target="_blank" id="url" name="url">{{ $campaign->campaign_url }}</a>
                                                        </fieldset>
                                                    </div>
                                                </div>                                               
                                                <div class="row">
