...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingwhitelistip.clienttrackingwhitelistip_edit'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingwhitelistip', 'update')}}" enctype="multipart/form-data">
