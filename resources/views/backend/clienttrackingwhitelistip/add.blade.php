...
@section('content')
    @include('backend.elements.content_action', ['title' => $title, 'action' => 'backend.elements.actions.clienttrackingwhitelistip.clienttrackingwhitelistip_add'])
    <form method="POST" id="admin-form" action="{{app('UrlHelper')::admin('clienttrackingwhitelistip', 'store')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <fieldset class="form-group">
                                                            <input type="text" name="ip" class="form-control" placeholder="Địa chỉ ip" required="">
                                                        </fieldset>
                                                    </div>
                                                </div>
                                                <div class="row">
