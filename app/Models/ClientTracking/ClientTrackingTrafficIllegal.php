...
class ClientTrackingTrafficIllegal extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_TRAFFICILLEGAL_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingTrafficIllegal', 'image_value' => config('my.image.value.clientTrackingTrafficIllegal.avatar'), 'image_status' => 'activated']);
    }
}
