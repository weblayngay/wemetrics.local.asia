...
class ClientTrackingUtmSource extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_UTMSOURCE_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'utmsource', 'image_value' => config('my.image.value.utmsource.avatar'), 'image_status' => 'activated']);
    }
}
