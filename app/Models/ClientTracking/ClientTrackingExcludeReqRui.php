...
class ClientTrackingExcludeReqRui extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_EXCLUDEREQUESTRUI_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingExcludeReqRui', 'image_value' => config('my.image.value.clientTrackingExcludeReqRui.avatar'), 'image_status' => 'activated']);
    }
}
