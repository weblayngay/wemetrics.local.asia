...
class ClientTrackingIllegalReqRui extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_ILLEGALREQUESTRUI_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingIllegalReqRui', 'image_value' => config('my.image.value.clientTrackingIllegalReqRui.avatar'), 'image_status' => 'activated']);
    }
}
