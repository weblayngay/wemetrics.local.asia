...
class ClientTrackingDevice extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_TRACKINGDEVICE_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingDevice', 'image_value' => config('my.image.value.clientTrackingDevice.avatar'), 'image_status' => 'activated']);
    }
}
