...
class ClientTrackingUtmCampaign extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_UTMCAMPAIGN_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'utmcampaign', 'image_value' => config('my.image.value.utmcampaign.avatar'), 'image_status' => 'activated']);
    }
}
