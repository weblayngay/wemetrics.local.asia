...
class ClientTrackingRegion extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_REGION_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingRegion', 'image_value' => config('my.image.value.clientTrackingRegion.avatar'), 'image_status' => 'activated']);
    }
}
