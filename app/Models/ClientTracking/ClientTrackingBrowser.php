...
class ClientTrackingBrowser extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_TRACKINGBROWSER_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingBrowser', 'image_value' => config('my.image.value.clientTrackingBrowser.avatar'), 'image_status' => 'activated']);
    }
}
