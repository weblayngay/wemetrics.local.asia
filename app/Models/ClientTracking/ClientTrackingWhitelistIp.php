...
class ClientTrackingWhitelistIp extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_TRACKINGWHITELIST_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingWhitelistIp', 'image_value' => config('my.image.value.clientTrackingWhitelistIp.avatar'), 'image_status' => 'activated']);
    }
}
