...
class ClientTrackingReplaceReqRui extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_REPLACEREQURUI_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingReplaceReqRui', 'image_value' => config('my.image.value.clientTrackingReplaceReqRui.avatar'), 'image_status' => 'activated']);
    }
}
