...
class ClientTrackingTrafficDetails extends BaseModel
{
    use HasFactory;
    protected $table    = CLIENTTRACKING_TRAFFICDETAILS_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'clientTrackingTrafficDetails', 'image_value' => config('my.image.value.clientTrackingTrafficDetails.avatar'), 'image_status' => 'activated']);
    }
}
