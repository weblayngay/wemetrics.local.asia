...
class GGAdwords extends BaseModel
{
    use HasFactory;
    protected $table    = GGADWORDS_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'ggadwords', 'image_value' => config('my.image.value.ggadwords.avatar'), 'image_status' => 'activated']);
    }
}
