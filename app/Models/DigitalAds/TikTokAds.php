...
class TikTokAds extends BaseModel
{
    use HasFactory;
    protected $table    = TIKTOKADS_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'tiktokads', 'image_value' => config('my.image.value.tiktokads.avatar'), 'image_status' => 'activated']);
    }
}
