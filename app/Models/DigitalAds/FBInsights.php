...
class FBInsights extends BaseModel
{
    use HasFactory;
    protected $table    = FBINSIGHTS_TBL;
    ...
    public function avatar(): HasOne
    {
        return parent::hasOne('App\Models\Image', '3rd_key', 'report_id')
            ->where(['3rd_type' => 'fbinsights', 'image_value' => config('my.image.value.fbinsights.avatar'), 'image_status' => 'activated']);
    }
}
