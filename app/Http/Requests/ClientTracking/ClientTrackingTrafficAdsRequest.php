...
class ClientTrackingTrafficAdsRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'utm_source'        => 'required|max:50',
            'utm_medium'        => 'required|max:50',
            'utm_campaign'      => 'required|max:255',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'utm_source.required' => 'Utm source không được để trống',
            'utm_source.max' => 'Utm source không vượt quá 50 ký tự',    
            'utm_medium.required' => 'Utm medium không được để trống',
            'utm_medium.max' => 'Utm medium không vượt quá 50 ký tự',  
            'utm_campaign.required' => 'Utm campaign không được để trống',
            'utm_campaign.max' => 'Utm campaign không vượt quá 255 ký tự',            
        ];
    }
}
