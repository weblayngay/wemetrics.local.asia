...
class getTotalOrderController extends BaseController
{
     ...
     */
    public function doGetTotalOrder($frmDate = '', $toDate = '')
    {
     ...
     * @return Application|Factory|View
     */
    public function doGetTotalOrderLatest($frmDate = '', $toDate = '', $mLimit = 10)
    {
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderProcessing($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderShipping($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderCanceled($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderCompleted($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderPaid($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetOrderPayOnline($frmDate = '', $toDate = '')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
     ...
     * @return Application|Factory|View
     */
    public function doGetTotalOrderByDate($frmDate = '', $toDate = '')
    {
     ...
     * @return Application|Factory|View
     */
    public function doGetTotalOrderItems($frmDate = '', $toDate = '', $mLimit = '10')
    {
     ...
     * @return Application|Factory|View
     */
    public function doGetTotalOrderCatItems($frmDate = '', $toDate = '')
    {
        $orders = $this->orderModel::from(LT4_PRODUCTS_ORDERS. " AS t1")
                ->selectRaw('t1.id, t1.rid, t1.order_total, t1.vdiscount, t1.engrave_fee, t1.amount, t1.status_id')
                ->whereRaw("DATE_FORMAT(DATE(t1.created), '%Y-%m-%d') BETWEEN '".$frmDate."' AND '".$toDate."'")
