...
use DB;
use App\Http\Controllers\Backend\Order\Report\Children\getTotalOrderByResellerController;
use App\Http\Controllers\Backend\Order\Report\Children\getResellerController;

class OrderWebsiteReportResellerController extends BaseController
{
    private $view = '.orderwebsitereportreseller';
    private $model = 'orderwebsitereportreseller';
    ...
    private $getTotalOrderResellerCtrl;
    ...
    public function __construct()
    {
        ...
        $this->getTotalOrderResellerCtrl = new getTotalOrderByResellerController();
    ...
    public function FntotalOrder($frmDate = '', $toDate = '', $reseller = '%')
    {
        ...
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrder($frmDate, $toDate, $reseller);
    ...
    public function FntotalOrderLatest($frmDate = '', $toDate = '', $mLimit = 10, $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrderLatest($frmDate, $toDate, $mLimit, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderProcessing($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderProcessing($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderShipping($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderShipping($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderCanceled($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderCanceled($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderByDate($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrderByDate($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderCompleted($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderCompleted($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderPaid($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderPaid($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderPayOnline($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetOrderPayOnline($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderByReseller($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrderByReseller($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }
    ...
    public function FntotalOrderItems($frmDate = '', $toDate = '', $reseller = '%', $mLimit = '10')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrderItems($frmDate, $toDate, $reseller, $mLimit);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }   
    ...
    public function FntotalOrderCatItems($frmDate = '', $toDate = '', $reseller = '%')
    {
        // \DB::enableQueryLog(); // Enable query log
        // Your Eloquent query executed by using post()
        $result = $this->getTotalOrderResellerCtrl->doGetTotalOrderCatItems($frmDate, $toDate, $reseller);
        // dd(\DB::getQueryLog()); // Show results of log
        return $result;
    }         
    ...
    {
        $data['title'] = ORDER_WEBSITE_REPORT_RESELLER_TITLE;
