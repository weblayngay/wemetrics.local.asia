...
class TableRestProxy extends ServiceRestProxy implements ITable
{
    ...
    private function _createBatchRequestBody($operations, $contexts)
    {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            case BatchOperationType::INSERT_MERGE_ENTITY_OPERATION:
                ...
                // User mb_strlen instead of strlen to get the length of the string
     ...
     *
     * @param array $values The OData menu values
     *
     * @return array
     */
     ...
     *
     * @param string $value The OData menu value
     *
     * @return string
     */
    private function _encodeODataUriValue($value)
    {
        ...
        // Encode the special menu characters
    ...
    public function queryTables($options = null)
    {
        ...
        // $filter appears in the menu. The current behavior is to just ignore the
