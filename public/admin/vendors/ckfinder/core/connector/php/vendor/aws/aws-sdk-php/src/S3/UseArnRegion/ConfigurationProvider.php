    ...
    implements ConfigurationProviderInterface
{
    ...
    {
        return function () {
            // User config from environment variables, if available
    ...
    public static function ini($profile = null, $filename = null)
    {
        ...
        return function () use ($profile, $filename) {
            ...
            // User INI_SCANNER_NORMAL instead of INI_SCANNER_TYPED for PHP 5.5 compatibility
            ...
            if (!isset($data[$profile][self::INI_USE_ARN_REGION])) {
                return self::reject("Required S3 User Arn Region config values
