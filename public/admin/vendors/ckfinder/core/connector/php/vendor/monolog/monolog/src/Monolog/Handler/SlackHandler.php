...
class SlackHandler extends SocketHandler
{
     ...
     * @param  int    $level
     * @return string
     * @deprecated User underlying SlackRecord instead
     */
    protected function getAttachmentColor($level)
    {
        trigger_error(
            'SlackHandler::getAttachmentColor() is deprecated. User underlying SlackRecord instead.',
            E_USER_DEPRECATED
        );
    ...
    {
        trigger_error(
            'SlackHandler::stringify() is deprecated. User underlying SlackRecord instead.',
            E_USER_DEPRECATED
        );
