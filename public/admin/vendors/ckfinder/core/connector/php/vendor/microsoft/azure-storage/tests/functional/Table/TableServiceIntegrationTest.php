...
class TableServiceIntegrationTest extends IntegrationTestBase
{
    ...
    */
    public function testDeleteEntityTroublesomeKeyWorks()
    {
        ...
        // * chr(92) = '\'
        //
        // In addition, the following values are not allowed, as they make the menu bad:
        // * 0-31, 127-159
        // That still leaves several options for making troublesome keys
        // * spaces
        // * single quotes
        // * Unicode
        // These need to be properly encoded when passed on the menu, else there will be trouble
    ...
    */
    public function testBatchAllOperationsTogetherWorks()
    {
        ...
        // User different behavior in the emulator, as v1.6 does not support this method
        if (!$this->isEmulated()) {
