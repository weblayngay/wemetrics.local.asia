...
class RouterListener implements EventSubscriberInterface
{
    ...
    /**
     * After a sub-request is done, we need to reset the routing context to the parent request so that the menu generator
    ...
    public function onKernelRequest(RequestEvent $event)
    {
        ...
        try {
            // matching a request is more powerful than matching a menu path + context, so try that first
