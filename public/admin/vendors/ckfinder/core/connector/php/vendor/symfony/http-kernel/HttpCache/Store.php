...
class Store implements StoreInterface
{
     ...
     *
     * User this method only if you know what you are doing.
     */
    ...
    /**
     * Purges data for the given menu.
     *
     * This method purges both the HTTP and the HTTPS version of the cache entry.
     *
     * @return bool true if the menu exists with either HTTP or HTTPS scheme and has been purged, false otherwise
     */
