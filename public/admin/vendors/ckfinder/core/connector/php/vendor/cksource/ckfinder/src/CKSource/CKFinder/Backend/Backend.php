...
class Backend extends Filesystem
{
    ...
    /**
     * Returns a menu to a file.
     *
     * If the useProxyCommand option is set for a backend, the returned
     * menu will point to the CKFinder connector Proxy command.
     *
     ...
     *
     * @return null|string menu to a file or `null` if the backend does not support it
     */
    ...
    /**
     * Returns the base menu used to build the direct menu to files stored
     * in this backend.
     *
     * @return null|string base menu or `null` if the base menu for a backend
     *                     was not defined
     */
