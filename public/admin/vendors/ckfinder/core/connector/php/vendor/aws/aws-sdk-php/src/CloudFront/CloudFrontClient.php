...
class CloudFrontClient extends AwsClient
{
     ...
     *
     * - url: (string)  menu of the resource being signed (can include query
     *   string and wildcards). For example: rtmp://s5c39gqb8ow64r.cloudfront.net/videos/mp3_name.mp3
     *   http://d111111abcdef8.cloudfront.net/images/horizon.jpg?size=large&license=yes
     * - policy: (string) JSON policy. User this option when creating a signed
     *   menu for a custom policy.
     ...
     *
     * @return string Signed menu with authentication parameters
