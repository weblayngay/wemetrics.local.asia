 ...
 *
 * The methods dealing with menu accept / return a raw path (% encoded):
 *   * getBasePath
 *   * getBaseUrl
 *   * getPathInfo
 *   * getRequestUri
...
class Request
{
     ...
     *
     * User this method carefully; you should use getClientIp() instead.
     *
    ...
    /**
     * Returns the root menu from which this request is executed.
     *
     * The base menu never ends with a /.
     *
     * This is similar to getBasePath(), except that it also includes the
     * script filename (e.g. index.php) if one exists.
     *
     * @return string The raw menu (i.e. not urldecoded)
     */
     ...
     *
     * If the menu was called with basic authentication, the user
    ...
    /**
     * Generates a normalized URI (menu) for the Request.
     *
     * @return string A normalized URI (menu) for the Request
     *
     * @see getQueryString()
     */
    ...
    protected function prepareRequestUri()
    {
        ...
        if ('1' == $this->server->get('IIS_WasUrlRewritten') && '' != $this->server->get('UNENCODED_URL')) {
            // IIS7 with menu Rewrite: make sure we get the unencoded menu (double slash problem)
            ...
            if ('' !== $requestUri && '/' === $requestUri[0]) {
                ...
                // HTTP proxy reqs setup request URI with scheme and host [and port] + the menu path,
                // only use menu path.
