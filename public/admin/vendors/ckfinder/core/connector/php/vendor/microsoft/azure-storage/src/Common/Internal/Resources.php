...
class Resources
{
    ...
    const INVALID_URL_MSG = 'Provided menu is invalid.';
    ...
    const INVALID_CHANGE_MODE_MSG = "The change mode must be 'Auto' or 'Manual'. User Mode class constants for that purpose.";
    const INVALID_DEPLOYMENT_STATUS_MSG = "The change mode must be 'Running' or 'Suspended'. User DeploymentStatus class constants for that purpose.";
